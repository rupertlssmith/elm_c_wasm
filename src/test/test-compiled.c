...
void *eval_elm_core_Maybe_Just(void *args[]) { return newCustom(CTOR_Just, 1, args); }
...
void *eval_elm_core_Result_Ok(void *args[]) { return newCustom(CTOR_Ok, 1, args); }
void *eval_elm_core_Result_Err(void *args[]) { return newCustom(CTOR_Err, 1, args); }
...
void *eval_elm_json_Json_Decode_Failure(void *args[]) { return newCustom(CTOR_Failure, 2, args); }
void *eval_elm_json_Json_Decode_Field(void *args[]) { return newCustom(CTOR_Field, 2, args); }
void *eval_elm_json_Json_Decode_Index(void *args[]) { return newCustom(CTOR_Index, 2, args); }
void *eval_elm_json_Json_Decode_OneOf(void *args[]) { return newCustom(CTOR_OneOf, 1, args); }
