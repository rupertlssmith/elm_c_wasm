...
FieldGroup fg5 = {.header = HEADER_FIELDGROUP(5), .size = 5, .fields = {263, 343, 575, 691, 763}};
FieldGroup fg10 = {
        .header = HEADER_FIELDGROUP(10), .size = 10, .fields = {44, 123, 180, 443, 522, 532, 583, 645, 752, 816}};
FieldGroup fg20 = {
        .header = HEADER_FIELDGROUP(20),
        .size = 20,
        .fields = {
                54, 129, 137, 313, 367, 406, 414, 423, 443, 610, 622, 652, 705, 710, 722, 741, 799, 871, 937, 984,
        }};
FieldGroup fg50 = {.header = HEADER_FIELDGROUP(50),
                   .size = 50,
                   .fields = {
                           2,   22,  45,  66,  87,  122, 134, 138, 167, 177, 218, 319, 320, 348, 368, 377, 383,
                           393, 428, 459, 507, 516, 536, 538, 557, 568, 577, 578, 587, 600, 622, 631, 635, 695,
                           730, 743, 763, 798, 804, 834, 857, 881, 895, 914, 921, 922, 934, 941, 951, 992,
                   }};

FieldGroup fg100 = {.header = HEADER_FIELDGROUP(100),
                    .size = 100,
                    .fields = {
                            1,   28,  33,  34,  43,  50,  63,  64,  65,  73,  93,  99,  126, 155, 168, 170, 175,
                            196, 204, 208, 216, 217, 228, 236, 241, 248, 262, 289, 297, 302, 320, 331, 333, 339,
                            360, 362, 362, 367, 379, 380, 382, 394, 400, 401, 410, 412, 430, 431, 439, 448, 453,
                            479, 480, 489, 491, 522, 534, 544, 546, 558, 558, 559, 560, 574, 579, 585, 589, 590,
                            612, 629, 640, 659, 670, 672, 699, 716, 740, 744, 747, 747, 756, 757, 763, 779, 787,
                            802, 816, 828, 829, 836, 876, 883, 888, 935, 947, 964, 965, 982, 983, 994,
                    }};
