...
void markJsRef(u32 id) { jsHeap[id].isMarked = true; }
...
void *getJsRefValue(u32 jsRefId) { return writeJsonValue(jsHeap[jsRefId].value, NOT_CIRCULAR); }
...
Record *jsRefToWasmRecord(u32 jsRefId) { return jsHeap[jsRefId].value; }

Tuple2 *Wrapper_setupOutgoingPort() { return NULL; }

u32 Wrapper_setupIncomingPort(u32 managerId) { return 0; }

Task *Wrapper_sleep(f64 time) { return NULL; }
...
void jsStepper(void *viewMetadata) { return; }
