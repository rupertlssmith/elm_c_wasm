 ...
 * not
 */
void *eval_not(void *args[]) { return (args[0] == &False) ? &True : &False; }
Closure Basics_not = {
        .header = HEADER_CLOSURE(0),
        .evaluator = &eval_not,
        .max_values = 1,
 ...
 * and
 */
void *eval_and(void *args[]) { return (args[0] == &True && args[1] == &True) ? &True : &False; }
Closure Basics_and = {
        .header = HEADER_CLOSURE(0),
        .evaluator = &eval_and,
        .max_values = 2,
 ...
 * or
 */
void *eval_or(void *args[]) { return (args[0] == &True || args[1] == &True) ? &True : &False; }
Closure Basics_or = {
        .header = HEADER_CLOSURE(0),
        .evaluator = &eval_or,
        .max_values = 2,
 ...
 * xor
 */
void *eval_xor(void *args[]) { return (args[0] != args[1]) ? &True : &False; }
Closure Basics_xor = {
        .header = HEADER_CLOSURE(0),
        .evaluator = &eval_xor,
        .max_values = 2,
...
void *eval_modBy(void *args[]) {
    ...
    return newElmInt(((answer > 0 && modulus < 0) || (answer < 0 && modulus > 0)) ? answer + modulus : answer);
}
 ...
 * identity
 */
void *eval_identity(void *args[]) { return args[0]; }
