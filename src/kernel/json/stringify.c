...
static void stringify_array(u32 indent, u32 indent_current, Custom *array, StringBuilder *sb) {
...
static void stringify_object(u32 indent, u32 indent_current, Custom *object, StringBuilder *sb) {
    u32 indent_next = indent_current + indent;
